...
$offset=$pagesize*($page - 1);//计算记录偏移量
    ...
    echo "共".$pages."页(".$page."/".$pages.")&nbsp;";
	  if($page>1){
	  	echo "<a href='pub.php?page=".$first."&ns=".$ns."'>首页</a>";
	  	echo "&nbsp;<a href='pub.php?page=".$pre."&ns=".$ns."'>上一页</a>";
	  }
	  
	  for($i=1;$i<$page;$i++)
	  	  echo "<a href='pub.php?page=".$i."&ns=".$ns."'>[".$i."]</a>";
	      echo "<font color='red'>[".$page."]</font>";
	  for($i=$page+1;$i<=$pages;$i++)
	  	 echo "<a href='pub.php?page=".$i."&ns=".$ns."'>[".$i."]</a>";  
	  
	  if($page<$pages){
	  	echo "<a href='pub.php?page=".$next."&ns=".$ns."'>下一页</a>";
	  	echo "<a href='pub.php?page=".$last."&ns=".$ns."'>&nbsp;尾页</a>";
	  }
...
<table width="100%" height="81" border="0" cellspacing="20" class='zt2' >
       ...
       return $str;
           ...
           $sql="select * from `goods` where username='".$username."' order by fabutime desc limit $offset,$pagesize ";
                  ...
                  while($arrn=mysql_fetch_array($result))
				   {
                            ...
                            echo "<tr>						      
                                  <td width='500' align='left'><a href='update_pub.php?id=$arrn[id]' title='$arrn[title]'><font color='#000'>$s</font></a></td>
