...
$sql="select count(*) from `goods` where type=1";
$rs=mysql_query($sql);
...
<div align="center">
<form method="post" name="form1" id="form1" action="check2.php">
  <table width="848" height="28" border="0" cellspacing="0" class='zt2'id="zt2">
   ...
   $result=mysql_query("select * from goods where type=1 order by fabutime asc limit $offset,$pagesize"); //根据前面的计算出开始的记录和记录数
  ...
  <input type="submit" name="button4" id="button4" value="禁止" />
</form>
</div>
<p align="center">&nbsp;</p>
</body>
