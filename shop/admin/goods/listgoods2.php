...
$sql="select count(*) from `goods` where type=2";
$rs=mysql_query($sql);
...
<form method="post" name="form1" id="form1" action="check.php">
  <table width="848" height="28" border="0" cellspacing="0" class='zt2'id="zt2">
   ...
   $result=mysql_query("select * from goods where type=2 order by fabutime asc limit $offset,$pagesize"); //根据前面的计算出开始的记录和记录数
